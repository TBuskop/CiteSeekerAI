...
SUBQUERY_MODEL = "gemini-2.0-flash" # gemini-2.5-pro-preview-03-25 (this is a paid one but the action is small so still chip)
CHAT_MODEL = "gemini-2.0-flash"  # gemini-2.5-pro-exp-03-25 (using free but good one for large requests)
